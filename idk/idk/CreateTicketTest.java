...
import org.apache.commons.httpclient.methods.*;
 ...
 public class CreateTicketTest {
 	...
 	protected static void post() throws HttpException, IOException {
 		// This must be valid json string with valid fields and values from table
        String hireString = "#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@";
 		String postData ="{\"sysparm_quantity\":\"1\",\"variables\":{\"Network_folder_to_be_granted\":\"" + hireString + "\",\"first_approver\":\"6a33af08dbd4a200bddfda9ebf96199a\"}}";
